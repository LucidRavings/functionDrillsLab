...
console.log(exclaimThree('down here'))
...
//CODE HERE
function maximumFrogs(gold){
  let frogs = 0
  while(gold >= 3){
    gold = gold - 3
    frogs++
    console.log("Gold remaining: " + gold)
  }
  return totalFrogs = frogs
}
totalFrogs = (maximumFrogs(34))
